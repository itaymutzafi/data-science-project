"""Return-based feature engineering and diagnostics."""
...
def add_return_features(dfs: Dict[str, pd.DataFrame]) -> None:
    """Add simple return and log-return columns from Close prices."""
    added = []
...
def return_day_boxplot(dfs: Dict[str, pd.DataFrame]) -> None:
    """Plot return distributions by day of week across tickers."""
...
def test_return_seasonality(dfs: Dict[str, pd.DataFrame]) -> None:
    """Run and display day/month seasonality tests for returns."""
    day_results = {}
    month_results = {}
